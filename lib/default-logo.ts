 ...
 * AgrarOffice-Grüntönen mit Amber-Akzent, mit eigener Hintergrundkachel, damit
 * es auf hellem wie dunklem Untergrund funktioniert.
 */
export const DEFAULT_LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-label="AgrarOffice">
  <defs>
