...
> = {
  ...
  "201100": { code: "201100", name: "Getreidesaatgut", kategorie: "Saatgut" },
  "201200": { code: "201200", name: "Hackfrüchtesaatgut", kategorie: "Saatgut" },
  "201300": { code: "201300", name: "Rübensaatgut", kategorie: "Saatgut" },
  "201400": { code: "201400", name: "Ölsaatensaatgut", kategorie: "Saatgut" },
  "204000": { code: "204000", name: "Pflanzenschutz (gesamt)", kategorie: "Pflanzenschutz" },
  "204100": { code: "204100", name: "Fungizide", kategorie: "Pflanzenschutz" },
  "204200": { code: "204200", name: "Herbizide", kategorie: "Pflanzenschutz" },
  "204300": { code: "204300", name: "Insektizide", kategorie: "Pflanzenschutz" },
  "206110": { code: "206110", name: "Einzelfutter pflanzlich", kategorie: "Futter" },
  "206120": { code: "206120", name: "Einzelfutter tierisch", kategorie: "Futter" },
  "206130": { code: "206130", name: "Mineralfutter", kategorie: "Futter" },
  "206210": { code: "206210", name: "Mischfutter Rinder", kategorie: "Futter" },
  "206220": { code: "206220", name: "Mischfutter Schweine", kategorie: "Futter" },
  "206230": { code: "206230", name: "Mischfutter Geflügel", kategorie: "Futter" },
};
...
export const PRODUKT_MAPPING_OUTPUT: Record<string, string> = {
  ...
  D0000: "Ölsaaten",
  POTATO: "Kartoffeln",
  SUG_BEET: "Zuckerrüben",
  MILK: "Milch",
  CATTLE: "Rinder",
  PIGS: "Schweine",
  POULTRY: "Geflügel",
  F0000: "Hackfrüchte",
  G0000: "Tierische Erzeugnisse",
};
...
const LABEL_MAPPING: Record<string, { code: string; name: string }> = {
  ...
  'potato': { code: 'POTATO', name: 'Kartoffeln' },
  'kartoffeln': { code: 'POTATO', name: 'Kartoffeln' },
  'sugar beet': { code: 'SUG_BEET', name: 'Zuckerrüben' },
  'zuckerrüben': { code: 'SUG_BEET', name: 'Zuckerrüben' },
  'sugarbeet': { code: 'SUG_BEET', name: 'Zuckerrüben' },
  'milk': { code: 'MILK', name: 'Milch' },
  'milch': { code: 'MILK', name: 'Milch' },
  'cattle': { code: 'CATTLE', name: 'Rinder' },
  'rinder': { code: 'CATTLE', name: 'Rinder' },
  'beef': { code: 'CATTLE', name: 'Rinder' },
  'pigs': { code: 'PIGS', name: 'Schweine' },
  'pig': { code: 'PIGS', name: 'Schweine' },
  'schweine': { code: 'PIGS', name: 'Schweine' },
  'poultry': { code: 'POULTRY', name: 'Geflügel' },
  'geflügel': { code: 'POULTRY', name: 'Geflügel' },
  'chickens': { code: 'POULTRY', name: 'Geflügel' },
  'root crops': { code: 'F0000', name: 'Hackfrüchte' },
  'hackfrüchte': { code: 'F0000', name: 'Hackfrüchte' },
  'animals': { code: 'G0000', name: 'Tierische Erzeugnisse' },
  'livestock': { code: 'G0000', name: 'Tierische Erzeugnisse' },
  'animal products': { code: 'G0000', name: 'Tierische Erzeugnisse' },
};
...
export const PRODUKT_BAUM: ProduktNode[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        dataset: "apri_pi15_inq",
        children: [
          { code: "201100", name: "Getreidesaatgut", dataset: "apri_pi15_inq" },
          { code: "201200", name: "Hackfrüchtesaatgut", dataset: "apri_pi15_inq" },
          { code: "201300", name: "Rübensaatgut", dataset: "apri_pi15_inq" },
          { code: "201400", name: "Ölsaatensaatgut", dataset: "apri_pi15_inq" },
        ],
      },
      {
        code: "204000",
        name: "Pflanzenschutz (gesamt)",
        dataset: "apri_pi15_inq",
        children: [
          { code: "204100", name: "Fungizide", dataset: "apri_pi15_inq" },
          { code: "204200", name: "Herbizide", dataset: "apri_pi15_inq" },
          { code: "204300", name: "Insektizide", dataset: "apri_pi15_inq" },
        ],
      },
      {
        code: "206000",
        ...
        children: [
          {
            ...
            dataset: "apri_pi15_inq",
            children: [
              { code: "206110", name: "Einzelfutter pflanzlich", dataset: "apri_pi15_inq" },
              { code: "206120", name: "Einzelfutter tierisch", dataset: "apri_pi15_inq" },
              { code: "206130", name: "Mineralfutter", dataset: "apri_pi15_inq" },
            ],
          },
          {
            code: "206200",
            ...
            dataset: "apri_pi15_inq",
            children: [
              { code: "206210", name: "Mischfutter Rinder", dataset: "apri_pi15_inq" },
              { code: "206220", name: "Mischfutter Schweine", dataset: "apri_pi15_inq" },
              { code: "206230", name: "Mischfutter Geflügel", dataset: "apri_pi15_inq" },
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        dataset: "apri_pi15_outq",
        children: [
          { code: "POTATO", name: "Kartoffeln", dataset: "apri_pi15_outq" },
          { code: "SUG_BEET", name: "Zuckerrüben", dataset: "apri_pi15_outq" },
        ],
      },
      {
        code: "G0000",
        name: "Tierische Erzeugnisse",
        dataset: "apri_pi15_outq",
        children: [
          { code: "MILK", name: "Milch", dataset: "apri_pi15_outq" },
          { code: "CATTLE", name: "Rinder", dataset: "apri_pi15_outq" },
          { code: "PIGS", name: "Schweine", dataset: "apri_pi15_outq" },
          { code: "POULTRY", name: "Geflügel", dataset: "apri_pi15_outq" },
        ],
      },
    ],
  },
