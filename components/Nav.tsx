...
const MODULE_HREFS: Record<string, string[]> = {
  ...
  "modul.tourenplanung": ["/tourenplanung", "/fahrer", "/fahrer/standorte"],
...
const groups: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/zwischenfruchtrechner", label: "Zwischenfrucht-Mischungsrechner", section: "Pflanze" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/retouren", label: "Retouren", section: "Lager" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/personal/arbeitszeiterfassung", label: "Arbeitszeiterfassung", section: "Abrechnung" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/statistik/kategorie-verlauf", label: "Kategorie-Verlauf", section: "Statistik" },
...
const PAGE_TITLE_MAP: Record<string, string> = {
  ...
  "/statistik/kategorie-verlauf": "Kategorie-Verlauf",
  ...
  "/zwischenfruchtrechner": "Zwischenfrucht-Mischungsrechner",
  ...
  "/personal/arbeitszeiterfassung": "Arbeitszeiterfassung",
