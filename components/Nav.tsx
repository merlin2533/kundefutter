...
const groups: NavGroup[] = [
  ...
  },
  {
    label: "Analyse",
    children: [
      { href: "/statistik", label: "Statistik-Übersicht" },
      { href: "/statistik/uebersicht", label: "Statistik-Dashboard" },
      { href: "/statistik/kunden", label: "Kundenauswertung" },
      { href: "/statistik/artikel", label: "Artikelauswertung" },
      { href: "/statistik/abc", label: "ABC-Analyse" },
      { href: "/statistik/saisonal", label: "Saisonal" },
      { href: "/statistik/angebote", label: "Angebots-Conversion" },
      { href: "/statistik/crm", label: "CRM-Aktivität" },
      { href: "/statistik/vorbestellungen", label: "Vorbestellungen" },
      { href: "/statistik/deckungsbeitrag", label: "Deckungsbeitrag" },
      { href: "/statistik/aging", label: "Offene-Posten-Aging" },
      { href: "/statistik/ausgaben", label: "Ausgaben-Auswertung" },
      { href: "/statistik/budget", label: "Budgetplanung" },
      { href: "/statistik/lieferanten", label: "Lieferanten / Einkauf" },
      { href: "/statistik/lager", label: "Lager-Auswertung" },
      { href: "/statistik/reklamationen", label: "Reklamationen" },
