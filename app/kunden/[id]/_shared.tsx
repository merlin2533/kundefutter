...
export const TABS = ["Stammdaten", "Lieferhistorie", "CRM", "Angebote", "Aufgaben", "Reklamationen", "Kontakte", "Bedarfe", "Notizen", "Sonderpreise", "Statistik", "Schlagkartei", "Düngebedarf", "Albrecht", "Tiere", "Agrarantrag", "Dokumente", "Vorgangskette", "Erklärungen"] as const;
