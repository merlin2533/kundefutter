        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-3 py-2.5 sm:py-1.5 text-sm rounded-lg border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium disabled:opacity-60 w-full sm:w-auto"
            >
            ...
            <button
              ...
              disabled={deleting}
              className="px-3 py-2.5 sm:py-1.5 text-sm rounded-lg border border-red-300 hover:bg-red-50 text-red-700 font-medium disabled:opacity-60 w-full sm:w-auto"
            >
