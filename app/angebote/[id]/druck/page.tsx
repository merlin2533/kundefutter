    ...
    <>
      <style>{`
        @media print {
          ...
          .angebot-scroll-wrapper { overflow: visible !important; }
      ...
      <div className="print-hidden sticky top-0 z-20 flex items-center flex-wrap gap-1.5 p-2.5 bg-white/95 backdrop-blur border-b border-gray-200 shadow-sm">
        ...
        <a
          href={`/api/exporte/angebot?angebotId=${id}`}
          download={`Angebot_${angebot.nummer}.pdf`}
      ...
      <div className="angebot-scroll-wrapper" style={{ overflowX: "auto" }}>
      <div
        data-print-area
        style={{
