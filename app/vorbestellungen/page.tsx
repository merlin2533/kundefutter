    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex flex-wrap justify-between items-center mb-6 gap-3">
        ...
        <div className="flex gap-2">
          <Link href="/einstellungen/fruehbezug" className="border px-4 py-2 rounded hover:bg-gray-50">Rabatt-Staffeln</Link>
          <Link href="/vorbestellungen/neu" className="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-800">+ Neue Vorbestellung</Link>
        </div>
      </div>
