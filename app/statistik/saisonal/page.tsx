...
export default function SaisonalPage() {
  // Dynamisch: die letzten verfügbaren Jahre aus der zentralen Jahresliste.
  const verfuegbareJahre = getJahreListeNum().slice(-4);
  const [selectedJahre, setSelectedJahre] = useState<number[]>(verfuegbareJahre.slice(-3));
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-6 print:px-0 print:py-0">
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-1 print:hidden">
        ...
        <span>›</span>
        <span className="text-gray-800 font-medium">Saisonale Auswertung</span>
      </div>
