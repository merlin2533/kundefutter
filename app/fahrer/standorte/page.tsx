      ...
      {!loading && positionen.length > 0 && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {positionen.map((pos) => {
              const mapsUrl = `https://www.openstreetmap.org/?mlat=${pos.lat}&mlon=${pos.lng}#map=15/${pos.lat}/${pos.lng}`;
              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-green-700 hover:bg-green-800 text-white text-sm font-medium rounded-xl transition-colors"
                  >
