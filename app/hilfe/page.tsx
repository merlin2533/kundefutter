...
const sections: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Mahnwesen mit automatischen Mahnstufen und konfigurierbaren Fristen" },
      { text: "Offene Posten: alle unbezahlten Rechnungen mit Mahnstufe" },
      { text: "DATEV-Export für Steuerberater" },
      { text: "ZUGFeRD/Factur-X XML: maschinell lesbare E-Rechnung" },
      { text: "Rechnung per E-Mail direkt aus der App versenden (SMTP oder Resend)" },
      { text: "Bankabgleich: CSV/MT940-Import und automatische Zuordnung" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Bodenproben mit pH, P2O5, K2O, Mg, Humus – je Schlag und Datum" },
      { text: "Albrecht-Bodenanalyse: ideale Verhältnisse und Zufuhrempfehlung" },
      { text: "Düngebedarfsermittlung nach DüV Anlage 4 (N, P, K, Mg)" },
      ...
      { text: "Sachkundenachweise je Kunde mit Ablaufdatum-Monitoring" },
      { text: "Zertifizierungen je Kunde (z.B. AMA, BIO, QS) mit Ablaufdatum" },
  ...
  },
  {
    ...
    color: "amber",
    link: "/rationsberechnung",
    features: [
      { text: "Tierbestand je Kunde erfassen: Tierart, Nutzungsart, Anzahl, Gewicht, Leistung" },
      { text: "Futterrationsberechnung für Rind, Schwein, Geflügel, Pferd, Schaf, Ziege" },
      { text: "Modus einfach (Ration → Bilanz) und detailliert (Grundfutter/Ausgleich/Leistungsfutter)" },
      { text: "Qualitätsindikatoren: Ca:P-Verhältnis, Aminosäuren, RNB, Rohfaser" },
      { text: "Eigene Futterwerte hinterlegen und mit Artikelinhaltsstoffen verknüpfen" },
      { text: "Rationen speichern und als Excel-Datei exportieren" },
      { text: "Nährstoffkalkulator: Analyse von Futtermitteln nach Inhaltsstoffen" },
    ],
  },
  {
    id: "einkauf",
    icon: "🛒",
    title: "Einkauf & Lieferantenbestellungen",
    color: "indigo",
    link: "/bestellungen",
    features: [
      { text: "Bestellliste: offene Bestellpositionen nach Lieferant gruppiert" },
      { text: "Lieferantenbestellungen erstellen und verwalten (Status: Offen → Bestätigt → Geliefert)" },
      { text: "Einkaufszettel: schnelle Erfassung von Bestellbedarf" },
      { text: "Eingangsrechnungen: Lieferantenrechnungen erfassen und verwalten" },
      { text: "Fracht und Mindestbestellwert je Lieferant in der Bestellliste sichtbar" },
      { text: "Frühbezugs-Staffeln: automatische Rabattberechnung für Vorbestellungen" },
      { text: "Vorbestellungen (Frühbezug): Saisonbestellungen verwalten und in Lieferungen umwandeln" },
      { text: "Kontrakte: Liefervereinbarungen mit Mengen-Abrufen verwalten" },
    ],
  },
  {
    id: "finanzen2",
    ...
    color: "emerald",
    link: "/finanzen/cashflow",
    features: [
      { text: "Cashflow-Übersicht: monatliche Einnahmen, Ausgaben und Liquidität" },
      { text: "Offene Posten Liste: alle offenen Rechnungen mit Mahnstufe und Fälligkeit" },
      { text: "Liquiditätsanalyse: rollierende 12-Monats-Vorschau" },
      { text: "Bankabgleich: CSV/MT940-Import, Zuordnung zu Rechnungen" },
      { text: "DATEV-Export für Steuerberater" },
      { text: "Budgetplanung: Monats-/Jahresbudget je Kategorie" },
    ],
  },
  {
    id: "reklamationen",
    ...
    link: "/reklamationen",
    features: [
      { text: "Reklamationen erfassen: Betreff, Kategorie (Qualität, Menge, Lieferung, Preis), Priorität" },
      { text: "Status-Tracking: Offen → In Bearbeitung → Gelöst → Geschlossen" },
      { text: "Verknüpfung mit Lieferung und Kunde" },
      { text: "Zuweisen an Mitarbeiter, Lösungsdatum tracken" },
      { text: "Statistik: Ø Lösezeit, offene Reklamationen, Kategorien-Auswertung" },
      { text: "Übersicht je Kunde im Kunden-Detail-Tab" },
    ],
  },
  {
    id: "kampagnen",
    ...
    link: "/kampagnen",
    features: [
      { text: "Marketingkampagnen erstellen mit Zeitraum, Rabatt und Artikelzuordnung" },
      { text: "Kampagnenstatus: Aktiv, Inaktiv, Abgelaufen, Zukünftig" },
      { text: "Potenzialanalyse je Kampagne: welche Kunden nutzen sie noch nicht?" },
      { text: "Kampagne bei Lieferungserstellung auswählen (automatischer Rabatt)" },
      { text: "Mailverteiler: Kunden nach Kampagnenzugehörigkeit segmentieren" },
    ],
  },
  {
    id: "ki",
    ...
    link: "/ki",
    features: [
      { text: "KI-Wareneingang: Lieferschein-Foto → automatisch Positionen erkennen" },
      { text: "KI-Lieferung: Bestellungs-Dokument → Lieferung vorausfüllen" },
      { text: "KI-CRM: Gesprächsnotizen aus Bild, Foto oder Diktat erfassen" },
      { text: "Diktieren: Sprachmemos direkt als CRM-Notiz transkribieren" },
      { text: "KI-Belegerkennung: Ausgaben-Beleg per Foto erkennen" },
      { text: "Churn-Risiko-Analyse: KI bewertet Abwanderungsrisiko je Kunde" },
      { text: "Inhaltsstoff-Recherche: KI sucht Nährstoffwerte für Artikel" },
      { text: "Mistral AI — Texterkennung, Dokument-OCR und Spracherkennung aus einer Hand" },
      { text: "Kostentracking: Nutzungsstatistik und Kosten je Feature" },
      { text: "MQTT-Automatisierung: eingehende Nachrichten per KI verarbeiten" },
    ],
  },
  {
    id: "portal",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Druckoptimierte Seiten: Lieferschein, Rechnung, Angebot, Kundenmappe, Düngebedarf" },
      { text: "Preisauskunft: schnelle Auskunft über Preise inkl. Sonderpreise" },
      { text: "DSGVO-Konformität: Auskunft, Export und Löschung personenbezogener Daten" },
      { text: "Multi-User mit Rollen: Admin und Benutzer" },
      { text: "Cron-Verwaltung: Hintergrundjobs überwachen und manuell auslösen" },
      { text: "System-Benachrichtigungen: Sachkunde-Ablauf, Lager-Alarm, Rechnungen" },
    ],
  },
];
