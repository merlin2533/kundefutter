...
/api/bankabgleich/[id]          PUT({...,differenzAktion?:"gutschrift"|"forderung"} — bei Zuordnung zu lieferungId/sammelrechnungId erfasst serverseitig berechnete Differenz Bankbetrag↔Rechnungsbrutto als Gutschrift/KundeForderung, atomar in derselben Transaktion), DELETE (hebt auch alle weitereZuordnungen dieses Kontoumsatzes auf)
